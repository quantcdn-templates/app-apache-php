...
export PHP_OPCACHE_REVALIDATE_FREQ="${PHP_OPCACHE_REVALIDATE_FREQ:-3600}"
export PHP_OPCACHE_MEMORY="${PHP_OPCACHE_MEMORY:-300}"
export PHP_OPCACHE_MAX_FILES="${PHP_OPCACHE_MAX_FILES:-30000}"
